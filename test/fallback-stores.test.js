...
describe("FALLBACK_STORES", () => {
  const EXPECTED_RETAILERS = ["costco", "totalwine", "walmart", "safeway", "albertsons", "walgreens", "samsclub", "extramile", "bevmo", "kroger"];
  ...
  it("has stores for costco, totalwine, walmart, safeway, albertsons, walgreens, samsclub, extramile", () => {
    ...
    expect(FALLBACK_STORES.extramile.length).toBeGreaterThan(0);
  });
