...
export const FALLBACK_STORES = {
  ...
  extramile: [
    { storeId: "chandler", name: "ExtraMile Liquors (Chandler Chevron)", address: "7000 W Chandler Blvd, Chandler, AZ 85226", distanceMiles: 6.0 },
  ],
  liquorexpress: [
    { storeId: "tempe-apache", name: "Liquor Express Tempe", address: "1605 E Apache Blvd, Tempe, AZ 85281", distanceMiles: 3.0 },
  ],
  chandlerliquors: [
    { storeId: "chandler-arizona-ave", name: "Chandler Liquors", address: "554 N Arizona Ave, Chandler, AZ 85225", distanceMiles: 7.0 },
  ],
  bevmo: [],
  kroger: [],
};
