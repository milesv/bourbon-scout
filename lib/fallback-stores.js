...
export const FALLBACK_STORES = {
  ...
  albertsons: [
    { storeId: "3067", name: "Albertsons Baseline Rd", address: "1951 W Baseline Rd, Mesa, AZ 85202", distanceMiles: 3.2 },
    { storeId: "3073", name: "Albertsons Ray Rd", address: "4060 W Ray Rd, Chandler, AZ 85226", distanceMiles: 3.5 },
    { storeId: "3015", name: "Albertsons Alma School Rd", address: "3145 S Alma School Rd, Chandler, AZ 85248", distanceMiles: 7.8 },
  ],
  walgreens: [
    { storeId: "3768", name: "Walgreens Tempe McClintock", address: "6404 S McClintock Dr, Tempe, AZ 85283", distanceMiles: 1.0 },
    { storeId: "2398", name: "Walgreens Tempe Baseline", address: "925 W Baseline Rd, Tempe, AZ 85283", distanceMiles: 1.5 },
    { storeId: "1197", name: "Walgreens Tempe Southern", address: "1745 E Southern Ave, Tempe, AZ 85282", distanceMiles: 2.5 },
    { storeId: "4376", name: "Walgreens Tempe Warner", address: "1825 E Warner Rd, Tempe, AZ 85284", distanceMiles: 3.0 },
  ],
  samsclub: [
    { storeId: "4956", name: "Sam's Club Tempe", address: "2080 E Rio Salado Pkwy, Tempe, AZ 85288", distanceMiles: 4.6 },
  ],
  // ExtraMile Liquors is a single Chevron store. We don't discover stores via API
  // since the merchant ID is hardcoded in the scraper — fallback always applies.
  extramile: [
    { storeId: "chandler", name: "ExtraMile Liquors (Chandler Chevron)", address: "7000 W Chandler Blvd, Chandler, AZ 85226", distanceMiles: 4.0 },
  ],
  bevmo: [],
  kroger: [],
};
...
export const EXTRA_STORES = {
  costco: [
    { storeId: "427", name: "Costco Scottsdale", address: "15255 N Hayden Rd, Scottsdale, AZ 85260", distanceMiles: 17 },
    { storeId: "1058", name: "Costco Paradise Valley", address: "4570 E Cactus Rd, Phoenix, AZ 85032", distanceMiles: 19 },
  ],
};
